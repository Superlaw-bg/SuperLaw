        ...
        <div className="container-fluid">
          ...
          <div className="row justify-content-around">
            <div className="col-md-4 col-xl-3">
              ...
              <p>
              Нашата платформа Ви предоставя възможност да създадете свой адвокатски профил с виртуален календар, чрез който вашите клиенти могат автоматично да запазят час за консултация в удобните за Вас часове. Бързо, лесно, гъвкаво и удобно.
              </p>
            </div>
            <div className="col-md-4 col-xl-3">
              <div className="img-wrapper">
