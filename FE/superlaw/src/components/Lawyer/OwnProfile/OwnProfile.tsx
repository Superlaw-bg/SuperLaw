       ...
       { profile && (!profile.id || profile.id === -1) && 
        ...
        <div className='wrapper'>
          <div className='text'>
            ...
            и телефон за връзка с вас. Като най-важното е, че можете там да задавате и управлявате графика Ви до 2 месеца напред с помощта на нашия календар. Чрез него потребителите ще могат да избират час и ден за консултация с Вас.
            Можете да обновявате информацията в профила си по всяко време, с изключение на вече заети времеви диапазони запазени за консултация с клиент.
            </p>
          </div>
